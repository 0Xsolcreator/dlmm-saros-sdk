...
})(exports.LiquidityShape || (exports.LiquidityShape = {}));
...
})(exports.RemoveLiquidityType || (exports.RemoveLiquidityType = {}));

var _CONFIG;
var CONFIG = (_CONFIG = {}, _CONFIG[exports.MODE.TESTNET] = {
  rpc: "https://api.testnet.solana.com"
}, _CONFIG[exports.MODE.DEVNET] = {
  rpc: "https://api.devnet.solana.com"
}, _CONFIG[exports.MODE.MAINNET] = {
...
var LiquidityBookAbstract = function LiquidityBookAbstract(config) {
  ...
  this.connection = new web3_js.Connection(rpcUrl, ((_config$options2 = config.options) == null ? void 0 : _config$options2.commitmentOrConfig) || "confirmed");
  var provider = new anchor.AnchorProvider(this.connection, {}, anchor.AnchorProvider.defaultOptions());
  this.lbProgram = new anchor.Program(LiquidityBookIDL, provider);
  this.hooksProgram = new anchor.Program(MdmaIDL, provider);
};
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 1:
          ...
          program = owner === spl.TOKEN_PROGRAM_ID.toBase58() ? spl.TOKEN_PROGRAM_ID : spl.TOKEN_2022_PROGRAM_ID;
...
var LBSwapService = /*#__PURE__*/function () {
  ...
  _proto2.getBinArray = function getBinArray(params) {
    var binArrayIndex = params.binArrayIndex,
      pair = params.pair;
    var binArray = web3_js.PublicKey.findProgramAddressSync([Buffer.from(anchor.utils.bytes.utf8.encode("bin_array")), pair.toBuffer(), new anchor.BN(binArrayIndex).toArrayLike(Buffer, "le", 4)], this.lbProgram.programId)[0];
    return binArray;
  };
...
function createUniformDistribution(params) {
  ...
  if (shape === exports.LiquidityShape.Spot) {
  ...
  if (shape === exports.LiquidityShape.Curve) {
    return getCurveDistributionFromBinRange(binRange);
  }
  if (shape === exports.LiquidityShape.BidAsk) {
...
var LiquidityBookServices = /*#__PURE__*/function (_LiquidityBookAbstrac) {
      ...
      return _regenerator().w(function (_context3) {
        while (1) switch (_context3.n) {
          case 0:
            ...
            binArray = web3_js.PublicKey.findProgramAddressSync([buffer.Buffer.from(anchor.utils.bytes.utf8.encode("bin_array")), pair.toBuffer(), new anchor.BN(binArrayIndex).toArrayLike(buffer.Buffer, "le", 4)], this.lbProgram.programId)[0];
      ...
      return _regenerator().w(function (_context6) {
        while (1) switch (_context6.n) {
          case 0:
            ...
            tokenX = new web3_js.PublicKey(tokenBase.mintAddress);
            tokenY = new web3_js.PublicKey(tokenQuote.mintAddress);
            ...
            tx = new web3_js.Transaction();
            binStepConfig = web3_js.PublicKey.findProgramAddressSync([buffer.Buffer.from(anchor.utils.bytes.utf8.encode("bin_step_config")), this.lbConfig.toBuffer(), new Uint8Array([binStep])], this.lbProgram.programId)[0];
            quoteAssetBadge = web3_js.PublicKey.findProgramAddressSync([buffer.Buffer.from(anchor.utils.bytes.utf8.encode("quote_asset_badge")), this.lbConfig.toBuffer(), tokenY.toBuffer()], this.lbProgram.programId)[0];
            pair = web3_js.PublicKey.findProgramAddressSync([buffer.Buffer.from(anchor.utils.bytes.utf8.encode("pair")), this.lbConfig.toBuffer(), tokenX.toBuffer(), tokenY.toBuffer(), new Uint8Array([binStep])], this.lbProgram.programId)[0];
            _context6.n = 1;
          ...
          case 1:
            ...
            binArrayLower = web3_js.PublicKey.findProgramAddressSync([buffer.Buffer.from(anchor.utils.bytes.utf8.encode("bin_array")), pair.toBuffer(), new anchor.BN(binArrayIndex).toArrayLike(buffer.Buffer, "le", 4)], this.lbProgram.programId)[0];
            binArrayUpper = web3_js.PublicKey.findProgramAddressSync([buffer.Buffer.from(anchor.utils.bytes.utf8.encode("bin_array")), pair.toBuffer(), new anchor.BN(Number(binArrayIndex) + 1).toArrayLike(buffer.Buffer, "le", 4)], this.lbProgram.programId)[0];
            _context6.n = 2;
            return this.lbProgram.methods.initializeBinArray(binArrayIndex).accountsPartial({
              pair: pair,
          ...
          case 2:
            ...
            _context6.n = 3;
            return this.lbProgram.methods.initializeBinArray(new anchor.BN(binArrayIndex + 1)).accountsPartial({
              pair: pair,
      ...
      return _regenerator().w(function (_context7) {
        while (1) switch (_context7.n) {
          case 0:
            ...
            position = web3_js.PublicKey.findProgramAddressSync([buffer.Buffer.from(anchor.utils.bytes.utf8.encode("position")), positionMint.toBuffer()], this.lbProgram.programId)[0];
            positionVault = spl.getAssociatedTokenAddressSync(positionMint, payer, true, spl.TOKEN_2022_PROGRAM_ID);
            _context7.n = 1;
            return this.getBinArray({
              binArrayIndex: binArrayIndex,
              pair: pair,
          ...
          case 2:
            _context7.n = 3;
            return this.lbProgram.methods.createPosition(new anchor.BN(relativeBinIdLeft), new anchor.BN(relativeBinIdRight)).accountsPartial({
              pair: pair,
              position: position,
      ...
      return _regenerator().w(function (_context8) {
        while (1) switch (_context8.n) {
          ...
          case 8:
            ...
            hook = web3_js.PublicKey.findProgramAddressSync([buffer.Buffer.from(anchor.utils.bytes.utf8.encode("hook")), this.hooksConfig.toBuffer(), pair.toBuffer()], this.hooksProgram.programId)[0];
            position = web3_js.PublicKey.findProgramAddressSync([buffer.Buffer.from(anchor.utils.bytes.utf8.encode("position")), positionMint.toBuffer()], this.lbProgram.programId)[0];
            positionVault = spl.getAssociatedTokenAddressSync(positionMint, payer, true, spl.TOKEN_2022_PROGRAM_ID);
            _context8.n = 9;
            return this.lbProgram.methods.increasePosition(new anchor.BN(amountX), new anchor.BN(amountY), liquidityDistribution).accountsPartial({
              pair: pair,
              position: position,
      ...
      return _regenerator().w(function (_context0) {
        while (1) switch (_context0.n) {
          ...
          case 2:
            ...
            txCreateAccount = new web3_js.Transaction();
            _context0.n = 3;
            return this.getPairVaultInfo({
          ...
          case 6:
            ...
            hook = web3_js.PublicKey.findProgramAddressSync([buffer.Buffer.from(anchor.utils.bytes.utf8.encode("hook")), this.hooksConfig.toBuffer(), pair.toBuffer()], this.hooksProgram.programId)[0];
            associatedHookTokenY = spl.getAssociatedTokenAddressSync(tokenMintY, hook, true, tokenProgramY);
            _context0.n = 7;
            return this.connection.getAccountInfo(associatedHookTokenY);
          case 7:
            infoHookTokenY = _context0.v;
            if (!infoHookTokenY) {
              hookTokenYInstructions = spl.createAssociatedTokenAccountInstruction(payer, associatedHookTokenY, hook, tokenMintY, tokenProgramY);
                ...
                return _regenerator().w(function (_context9) {
                  while (1) switch (_context9.n) {
                    ...
                    case 3:
                      ...
                      tx = new web3_js.Transaction();
                      tx.add(web3_js.ComputeBudgetProgram.setComputeUnitLimit({
                        units: CCU_LIMIT
                      }));
                      tx.add(web3_js.ComputeBudgetProgram.setComputeUnitPrice({
                        microLamports: unitPrice
                      }));
                      positionVault = spl.getAssociatedTokenAddressSync(new web3_js.PublicKey(positionMint), payer, true, spl.TOKEN_2022_PROGRAM_ID);
                      _t2 = cloneDeep;
                      _context9.n = 4;
                    ...
                    case 4:
                      ...
                      hookBinArrayLower = web3_js.PublicKey.findProgramAddressSync([buffer.Buffer.from(anchor.utils.bytes.utf8.encode("bin_array")), hook.toBuffer(), new anchor.BN(BIN_ARRAY_INDEX).toArrayLike(buffer.Buffer, "le", 4)], _this.hooksProgram.programId)[0];
                      hookBinArrayUpper = web3_js.PublicKey.findProgramAddressSync([buffer.Buffer.from(anchor.utils.bytes.utf8.encode("bin_array")), hook.toBuffer(), new anchor.BN(BIN_ARRAY_INDEX + 1).toArrayLike(buffer.Buffer, "le", 4)], _this.hooksProgram.programId)[0];
                      hookPosition = web3_js.PublicKey.findProgramAddressSync([buffer.Buffer.from(anchor.utils.bytes.utf8.encode("position")), hook.toBuffer(), new web3_js.PublicKey(position).toBuffer()], _this.hooksProgram.programId)[0];
                      removedShares = [];
                      if (type === "removeBoth") {
                      ...
                      availableShares = reserveXY.filter(function (item) {
                        return type === "removeBoth" ? !new anchor.BN(item.liquidityShare).eq(new anchor.BN(0)) : type === "removeQuoteToken" ? !item.reserveX : !item.reserveY;
                      });
          ...
          case 9:
            txs = _context0.v;
            txCloseAccount = new web3_js.Transaction();
      ...
      return _regenerator().w(function (_context10) {
        while (1) switch (_context10.n) {
          ...
          case 9:
            ...
            associatedPairVaultX = spl.getAssociatedTokenAddressSync(tokenMintX, pair, true, tokenProgramX);
            associatedPairVaultY = spl.getAssociatedTokenAddressSync(tokenMintY, pair, true, tokenProgramY);
            associatedUserVaultX = spl.getAssociatedTokenAddressSync(tokenMintX, payer, true, tokenProgramX);
            associatedUserVaultY = spl.getAssociatedTokenAddressSync(tokenMintY, payer, true, tokenProgramY);
            _context10.n = 10;
            return this.connection.getAccountInfo(associatedUserVaultX);
          case 10:
            infoUserVaultX = _context10.v;
            if (!infoUserVaultX) {
              userVaultXInstructions = spl.createAssociatedTokenAccountInstruction(payer, associatedUserVaultX, payer, tokenMintX, tokenProgramX);
          ...
          case 11:
            ...
            if (!infoUserVaultY) {
              userVaultYInstructions = spl.createAssociatedTokenAccountInstruction(payer, associatedUserVaultY, payer, tokenMintY, tokenProgramY);
              tx.add(userVaultYInstructions);
            }
            hookBinArrayLower = web3_js.PublicKey.findProgramAddressSync([buffer.Buffer.from(anchor.utils.bytes.utf8.encode("bin_array")), hook.toBuffer(), new anchor.BN(BIN_ARRAY_INDEX).toArrayLike(buffer.Buffer, "le", 4)], this.hooksProgram.programId)[0];
            hookBinArrayUpper = web3_js.PublicKey.findProgramAddressSync([buffer.Buffer.from(anchor.utils.bytes.utf8.encode("bin_array")), hook.toBuffer(), new anchor.BN(BIN_ARRAY_INDEX + 1).toArrayLike(buffer.Buffer, "le", 4)], this.hooksProgram.programId)[0];
            if (tokenMintY.toString() === WRAP_SOL_ADDRESS || tokenMintX.toString() === WRAP_SOL_ADDRESS) {
              isNativeY = tokenMintY.toString() === WRAP_SOL_ADDRESS;
              associatedUserVault = isNativeY ? associatedUserVaultY : associatedUserVaultX;
              if (isNativeY && !swapForY) {
                tx.add(web3_js.SystemProgram.transfer({
                  fromPubkey: payer,
                  toPubkey: associatedUserVault,
                  lamports: amount
                }));
            ...
            _context10.n = 12;
            return this.lbProgram.methods.swap(new anchor.BN(amount.toString()), new anchor.BN(otherAmountOffset.toString()), swapForY, isExactInput ? {
              exactInput: {}
            } : {
              exactOutput: {}
            }).accountsPartial({
          ...
          case 12:
            ...
            if (tokenMintY.toString() === WRAP_SOL_ADDRESS || tokenMintX.toString() === WRAP_SOL_ADDRESS) {
              ...
              if (_isNativeY && swapForY || !_isNativeY && !swapForY) {
                tx.add(spl.createCloseAccountInstruction(_associatedUserVault, payer, payer));
              }
            }
    ...
    var _fetchPoolAddresses = /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee13() {
      ...
      return _regenerator().w(function (_context13) {
        while (1) switch (_context13.n) {
          ...
          case 1:
            _context13.n = 2;
            return connection.getProgramAccounts(new web3_js.PublicKey(programId), {
              filters: [{
                memcmp: {
                  offset: 0,
                  bytes: bytes.bs58.encode(pairAccountDiscriminator)
                }
              }]
            });
          case 2:
        ...
        while (1) switch (_context15.n) {
          ...
          case 1:
            ...
            positionMints = tokenAccounts.value.filter(function (acc) {
              ...
              return new web3_js.PublicKey(acc.account.data.parsed.info.mint);
            });
            _context15.n = 2;
              ...
              var _ref6 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee14(mint) {
                ...
                return _regenerator().w(function (_context14) {
                  while (1) switch (_context14.p = _context14.n) {
                    case 0:
                      _context14.n = 1;
                      return web3_js.PublicKey.findProgramAddressSync([buffer.Buffer.from(anchor.utils.bytes.utf8.encode("position")), mint.toBuffer()], _this3.lbProgram.programId);
                    case 1:
        ...
        while (1) switch (_context16.n) {
          case 0:
            ...
            return this.getQuote({
              ...
              pair: new web3_js.PublicKey(metadata.poolAddress),
              slippage: optional.slippage,
              swapForY: optional.swapForY,
              tokenBase: new web3_js.PublicKey(metadata.baseMint),
              tokenBaseDecimal: metadata.extra.tokenBaseDecimal,
              tokenQuote: new web3_js.PublicKey(metadata.quoteMint),
      ...
      return _regenerator().w(function (_context17) {
        while (1) switch (_context17.n) {
          case 0:
            ...
            _context17.n = 1;
            return this.lbProgram.account.pair.fetch(new web3_js.PublicKey(pair));
          case 1:
          ...
          case 2:
            _context17.n = 3;
            return this.getPairVaultInfo({
              tokenAddress: new web3_js.PublicKey(pairInfo.tokenMintX),
              pair: new web3_js.PublicKey(pair)
            });
          case 3:
            basePairVault = _context17.v;
            _context17.n = 4;
            return this.getPairVaultInfo({
              tokenAddress: new web3_js.PublicKey(pairInfo.tokenMintY),
              pair: new web3_js.PublicKey(pair)
            });
          case 4:
      ...
      return _regenerator().w(function (_context18) {
        while (1) switch (_context18.n) {
          case 0:
            ...
            tokenMint = new web3_js.PublicKey(tokenAddress);
            _context18.n = 1;
            return getProgram(tokenMint, this.connection);
          case 1:
            tokenProgram = _context18.v;
            associatedPairVault = spl.getAssociatedTokenAddressSync(tokenMint, pair, true, tokenProgram);
            if (!(transaction && payer)) {
              _context18.n = 3;
              break;
            }
          ...
          case 2:
            ...
            if (!infoPairVault) {
              pairVaultYInstructions = spl.createAssociatedTokenAccountInstruction(payer, associatedPairVault, pair, tokenMint, tokenProgram);
      ...
      return _regenerator().w(function (_context19) {
        while (1) switch (_context19.n) {
          ...
          case 1:
            ...
            associatedUserVault = spl.getAssociatedTokenAddressSync(tokenAddress, payer, true, tokenProgram);
            if (!transaction) {
              _context19.n = 3;
              break;
            }
          ...
          case 2:
            ...
            if (!infoUserVault) {
              userVaultYInstructions = spl.createAssociatedTokenAccountInstruction(payer, associatedUserVault, payer, tokenAddress, tokenProgram);
      ...
      return _regenerator().w(function (_context22) {
        while (1) switch (_context22.n) {
          ...
          case 2:
            ...
            message = web3_js.TransactionMessage.decompile(compiledMessage);
            instructions = message.instructions;
            initializePairStruct = LiquidityBookIDL.instructions.find(function (item) {
              return item.name === "initialize_pair";
            });
            initializePairDescrimator = buffer.Buffer.from(initializePairStruct.discriminator);
            pairAddress = "";
  ...
  return _createClass(LiquidityBookServices, [{
    key: "lbConfig",
    get: function get() {
      return new web3_js.PublicKey("BqPmjcPbAwE7mH23BY8q8VUEN4LSjhLUv41W87GsXVn8");
    }
  }, {
    key: "hooksConfig",
    get: function get() {
      return new web3_js.PublicKey("DgW5ARD9sU3W6SJqtyJSH3QPivxWt7EMvjER9hfFKWXF");
    }
  }]);
}(LiquidityBookAbstract);

exports.ACTIVE_ID = ACTIVE_ID;
exports.BASE_FACTOR = BASE_FACTOR;
exports.BASIS_POINT_MAX = BASIS_POINT_MAX;
exports.BIN_ARRAY_INDEX = BIN_ARRAY_INDEX;
exports.BIN_ARRAY_SIZE = BIN_ARRAY_SIZE;
exports.BIN_STEP = BIN_STEP;
exports.BIN_STEP_CONFIGS = BIN_STEP_CONFIGS;
exports.CCU_LIMIT = CCU_LIMIT;
exports.CONFIG = CONFIG;
exports.DECAY_PERIOD = DECAY_PERIOD;
exports.FILTER_PERIOD = FILTER_PERIOD;
exports.FIXED_LENGTH = FIXED_LENGTH;
exports.LiquidityBookServices = LiquidityBookServices;
exports.MAX_BASIS_POINTS = MAX_BASIS_POINTS;
exports.MAX_VOLATILITY_ACCUMULATOR = MAX_VOLATILITY_ACCUMULATOR;
exports.ONE = ONE;
exports.PRECISION = PRECISION;
exports.PROTOCOL_SHARE = PROTOCOL_SHARE;
exports.REDUCTION_FACTOR = REDUCTION_FACTOR;
exports.REWARDS_DURATION = REWARDS_DURATION;
exports.REWARDS_PER_SECOND = REWARDS_PER_SECOND;
exports.SCALE_OFFSET = SCALE_OFFSET;
exports.START_TIME = START_TIME;
exports.UNIT_PRICE_DEFAULT = UNIT_PRICE_DEFAULT;
exports.VARIABLE_FEE_CONTROL = VARIABLE_FEE_CONTROL;
exports.VARIABLE_FEE_PRECISION = VARIABLE_FEE_PRECISION;
exports.WRAP_SOL_ADDRESS = WRAP_SOL_ADDRESS;
exports.createUniformDistribution = createUniformDistribution;
exports.findPosition = findPosition;
exports.getBinRange = getBinRange;
exports.getGasPrice = getGasPrice;
exports.getMaxBinArray = getMaxBinArray;
exports.getMaxPosition = getMaxPosition;
//# sourceMappingURL=dlmm-sdk.cjs.development.js.map
